...
public static class CommandFactory
{
    public static RootCommand CreateRootCommand()
    {
        ...
        {
            Description = "Output format for people or tools: human, json, markdown, md, yaml, yml, csv (query only).",
            Recursive = true,
            DefaultValueFactory = _ => "human"
        };
        formatOption.AcceptOnlyFromAmong("human", "json", "markdown", "md", "yaml", "yml", "csv");
            ...
            return CliRunner.RunAsync(format, logLevel, static (_, _) =>
                Task.FromResult(new CliOutput
                {
                        ...
                        [
                            ...
                            ["Run KQL", "kusto query \"StormEvents | take 1\" --format yaml --cluster help --database Samples"],
    ...
    private static Command BuildQueryCommand(Option<string> formatOption, Option<string?> logLevelOption)
    {
        ...
        queryCommand.SetAction((parseResult, cancellationToken) =>
        {
            ...
            }, cancellationToken, OutputFormat.Human, OutputFormat.Json, OutputFormat.Markdown, OutputFormat.Yaml, OutputFormat.Csv);
        });
